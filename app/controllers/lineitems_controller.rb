class LineitemsController < ApplicationController
  ...
  def create
    ...
    @lineitem = @cart.add_item(product)

    respond_to do |format|
      if @lineitem.save
        format.html { redirect_to shopper_url, notice: 'Lineitem was successfully created.' }
        #After Add to Cart, will be redirected back to catalog
        format.js { redirect_to shopper_url, notice: 'Lineitem was successfully created.' }
